...
<div class="container-fluid padding">
	<div class="row padding">
		<div class="col-lg-6">
			<h2>Reflection 2: Second Week of USERDES Class</h2>
			<p><style> p {text-indent:50px;t}</style>In our second week of USERDES class, we are now starting our actual project. I was
surprised by becoming one of the leaders. I am very contented with my members, especially
being able to pick someone whom I am confident to be in a group with. And learning about need
finding in our class, we thought about what are the problems that we encounter with our daily
lives. The first things that popped out were, of course, traffic. But sadly, we couldn&#39;t find a
possible solution that we could actually implement with our current resources. Another topic
was implementing maps for malls but was later on scrapped because of the problem of how we
could acquire the actual blueprints from the malls. And finally, we came into a conclusion of
taking the problems concerning health, specifically the problems of obesity.</p>
            <p>Once we came to a conclusion of the topic, we then discussed what could we do to solve a
problem such as obesity. We then thought about what are the main causes of obesity. And that
would be overeating, neglecting proper exercise and not taking action on the first signs. We also
thought that maybe the cause of obesity is due to people not knowing the possible risks of being
overweight. So on our application, we are planning on including information on what could
possibly happen to a person when they are overweight. What are the possible health risks, and
the benefits if they took action now to improve their health. We actually concentrated mainly on
creating a mobile application because fitness-focused applications such as ours are mainly on
mobile. So that the users can access the application wherever they go with their phones.</p>
            <p>Overall the tasks in our digital design class are piling up, but I will continue to persevere
further in learning more in our class.</p>
        <div class="col-lg-6">
		</div>
			<br>
