...
<div class="container-fluid padding">
	<div class="row padding">
		<div class="col-lg-6">
			<h2>Activity 5:</h2>
            <h1>Lagsac, Andre M.</h1>
            <h1>Pasaporte, Gabrielle</h1>
            <h1>Dimaano, Marvin</h1>
            <h1>Nucum, Justin Mikael</h1>
		
        <div class="col-lg-6">
			<img src="img/project1.png" alt="woman sitting on a desk" class="img-fluid">
		</div>
        <div class="col-lg-6">
			<img src="img/project2.png" alt="woman sitting on a desk" class="img-fluid">
		</div>
        <div class="col-lg-6">
			<img src="img/project3.png" alt="woman sitting on a desk" class="img-fluid">
		</div>
        <div class="col-lg-6">
			<img src="img/project4.png" alt="woman sitting on a desk" class="img-fluid">
		</div>
        <div class="col-lg-6">
			<img src="img/project5.png" alt="woman sitting on a desk" class="img-fluid">
		</div>
        <div class="col-lg-6">
			<img src="img/project6.png" alt="woman sitting on a desk" class="img-fluid">
		</div>
        <div class="col-lg-6">
		</div>
        <div class="col-lg-6">
			<img src="img/project7.png" alt="woman sitting on a desk" class="img-fluid">
		</div>
        <div class="col-lg-6">
		</div>
			<br>
